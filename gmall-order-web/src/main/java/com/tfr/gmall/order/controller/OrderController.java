package com.tfr.gmall.order.controller;
        ...
        if (success.equals("success")) {
            ...
            for (OmsCartItem omsCartItem : omsCartItems) {
                if (omsCartItem.getIsChecked().equals("1")) {
                    ...
                    omsOrderItem.setProductSkuCode("1233211234567");
            ...
            mv=new ModelAndView("redirect:http://payment.gmall.com:8089/index");
